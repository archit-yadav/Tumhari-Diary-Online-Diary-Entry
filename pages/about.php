...
<div class="row my-5">
    <div class=" col-lg-6 diary_background read_window p-3">
        ...
        <div class="entry_font">
            <p>
                Hi folks! <br>
                My name is Archit Yadav. I have been working as a freelance web developer since 2020 and currently pursuing a master's degree in computer's applications from Jawaharlal Nehru University, New Delhi.
            ...
            <div class="socials mt-5">
                <span><a href="https://www.instagram.com/archit.yadav_/"><i class="fa-brands fa-instagram" style="color: #ffffff;"></i></i></a></span>
                <span class="mx-5"><a href="https://www.linkedin.com/in/-archityadav/"><i class="fa-brands fa-linkedin" style="color: #ffffff;"></i></a></span>
                <span><a href="https://github.com/archit-yadav?tab=repositories"><i class="fa-brands fa-github" style="color: #ffffff;"></i></a></span>
            </div>
        </div>
